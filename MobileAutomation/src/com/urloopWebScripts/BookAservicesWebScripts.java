...
public class BookAservicesWebScripts {
	...
	public void bookAservices(BookAserviceWeb_Object bookAserviceWeb_Object) throws InterruptedException{
		...
		/*bookAserviceWeb_Object.WebBookAServices.click();*/
		Thread.sleep(15000);
		...
		Thread.sleep(5000);	
		  ...
		  Thread.sleep(5000);
		  Browser.driver.findElement(By.xpath(".//*[@class='selectBox-values']/div[text()='Ganesh Janakiraman']")).click();
		  ...
		  Thread.sleep(5000);
		  Browser.driver.findElement(By.xpath(".//*[@id='modal-box']/div[2]/md-content/form/div[7]/div[2]/a[2]/button/span[text()='Save']")).click();
