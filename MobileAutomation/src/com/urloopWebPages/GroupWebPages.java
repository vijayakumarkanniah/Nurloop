...
public class GroupWebPages {
	...
	@Test(priority = 2)
	public void createGroupsStaff() throws InterruptedException, AWTException {
	...
	@Test(priority = 3)
	public void createGroupsResident() throws InterruptedException, AWTException {
	...
	@Test(priority = 4)
	public void createGroupsEveryOne() throws InterruptedException, AWTException {
	...
	@Test(priority = 6)
	public void feedPosting() throws InterruptedException, AWTException{
		groupGS.setFeedPost(testDataSheet.getCellValue("FeedPosting", "Groups", "FeedDetails"));
		groupWebScripts.feedPosting(groupGS);
	}
}
